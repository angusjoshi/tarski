...
\subfigprime{0}{0}{If $f(p)_i \leq p_i$ then}{$(p, u)$ is an up-set witness}{\rowthrcoltwo}
\subfigprime{16}{0}{If $f(p)_i \geq p_i$ then}{$(a, p)$ is an up-set witness}{\rowthrcolthr}
