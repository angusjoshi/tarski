\section{Basic Algorithms and Lower Bounds}
...
\end{notation}
\begin{algorithm}
  \caption{Kleene Tarski Iteration. An iterative algorithm for finding fixpoints.}
...
on the problem.
\begin{theorem}[\citep{lowerBound}]\label{lowerBoundThm}
...
\begin{algorithm}[h]
  \caption{\citep{dangQiYe}. A binary-search-like algorithm for finding fixpoints.}\label{dQiYiAlg}
  \begin{algorithmic}[1]
