...
$N$ can be represented with $\log N$ bits of information. At the time of writing
...
points in higher dimensions - crucially using the inner algorithm - to a sort of product of 3 dimensional
