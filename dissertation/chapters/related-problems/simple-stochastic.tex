...
by inverting a (necessarily invertible) matrix, leading to our definition of the expected value under 
...
\begin{proof}
  ...
  \end{align*}
  Rearranging and dividing through by $\beta$ gives the claim.
\end{proof}
