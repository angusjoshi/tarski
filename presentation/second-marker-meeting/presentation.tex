...
\frametitle{The problem, Lower Bounds}
    \begin{Definition}[\textsc{Tarski}]
        ...
        $f(x) = x$.
    \end{Definition}
    \begin{Theorem}[Etessami, Papadimitriou, Rubinstein, Yannakakis, '20]
...
\begin{Theorem}[Fearnley, Pálvölgyi, Savani, '21]
...
\begin{figure}[ht]
  ...
  \raisebox{-0.62\height}{\input{preprocess.tex}}
  \hfil
  $\mapsto$
  \hfil
  \raisebox{-0.5\height}{\input{preprocessAfter.tex}}
  \end{figure}
  \end{frame}
...
\frametitle{Reduction to \textsc{Tarski}}
    \begin{Theorem}[Gärtner, Haslebacher, Hoang, '21]
